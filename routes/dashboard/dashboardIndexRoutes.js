...
const { get_seller_dashboard_data,get_admin_dashboard_data,get_admin_dashboard_category_price_fluctuations,get_seller_dashboard_category_price_fluctuations, get_admin_dashboard_category_yield_fluctuations, getSellerPopularityRate,get_admin_dashboard_commodity_price_fluctuations,get_admin_dashboard_commodity_yield_fluctuations} = require('../../controllers/dashboard/dashboardIndexController')
...
router.get('/admin/get_seller_dashboard_commodity_yield_fluctuations',get_admin_dashboard_commodity_yield_fluctuations)



router.get('/seller/get_seller_dashboard_commodity_price_fluctuations',get_admin_dashboard_commodity_price_fluctuations)
router.get('/admin/get-seller-pr',getSellerPopularityRate)
